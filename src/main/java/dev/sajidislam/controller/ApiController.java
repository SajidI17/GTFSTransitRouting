...
public class ApiController {
    ...
    public List<BusStopWeb> apitest(@RequestParam String busStopOrigin, @RequestParam String busStopDest, @RequestParam String time, @RequestParam int date, @RequestParam String weekDayType){
        List<BusStopWeb> busStopWebList = Arrays.asList(new BusStopWeb("9822","Walking","Walking","10:40:00","CB990",45.421256,-75.699077),
                new BusStopWeb("CB990","99815558","1-350","10:39:00","CD990",45.421542,-75.698485),
                new BusStopWeb("CD990","99815558","1-350","10:37:00","CD998",45.426057,-75.692039),
                new BusStopWeb("CD998","99815558","1-350","10:35:00","CE990",45.420782,-75.682776),
                new BusStopWeb("CE990","99815558","1-350","10:33:00","AF990",45.416342,-75.670478),
                ...
                new BusStopWeb("5769","31815090","25","09:55:13","5769",45.464257,-75.477115));
